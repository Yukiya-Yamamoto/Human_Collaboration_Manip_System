...
class SYSTEM_MANAGE():
    def __init__(self):
        # set server
        rospy.Service('sys_manage_service_2',SystemManagement,self.callback)
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        rospy.wait_for_service('sys_manage_service_1')
        ...
        try:
            ...
            print(srv)
            proxy = rospy.ServiceProxy('sys_manage_service_1', SystemManagement)
            result = proxy(srv)
            print(result)
